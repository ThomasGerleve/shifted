admin = [true, true, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false]
...
# functional_role
functional_roles = ["nurse manager", "nurse manager", "nurse manager", "radiology nurse", "labor & delivery nurse", "emergency-room nurse", "intensive-care-unit nurse", "radiology nurse", "labor & delivery nurse", "emergency-room nurse", "intensive-care-unit nurse", "radiology nurse", "labor & delivery nurse", "emergency-room nurse", "intensive-care-unit nurse", "radiology nurse", "labor & delivery nurse", "emergency-room nurse", "intensive-care-unit nurse", "radiology nurse"]
# preferred_slots
...
# slots
slots = ["early", "late", "night", "early", "late", "night", "early", "late", "night", "early", "late", "night", "early", "late", "night", "early", "late", "night", "early", "late"]
# date
...
# user_shifts
status = ["open", "assigned", "open", "assigned", "open", "assigned", "open", "assigned", "open", "open", "assigned", "open", "assigned", "open", "assigned", "open", "assigned", "open", "assigned", "open"]
...
functional_roles.each do |functional_role|
  FunctionalRole.create(name: functional_role)
end
...
20.times do
  user = User.new(
    ...
    name: FunctionalRole.find_by(name: functional_roles[index])
  )
  index += 1
end
